...
int main(int argc, char** argv)
{
	...
	unsigned int dinoSpino = CreateTexture(strExePath + "\\Museum\\Animals\\Dinosaur3\\Material__36_albedo.jpg");
	...
	unsigned int secondSnakeTexture = CreateTexture(strExePath + "\\Museum\\Animals\\ThirdSnake\\Material.001.png");
	unsigned int thirdSnakeTexture = CreateTexture(strExePath + "\\Museum\\Animals\\SecondSnake\\metalnessMap1.png");
...
void renderWolf()
{
	...
	if (wolfVAO == 0)
	{
		...
		Loader.LoadFile("..\\Museum\\Animals\\Wolf1\\WOLF.obj");
		objl::Mesh curMesh = Loader.LoadedMeshes[0];
		int size = curMesh.Vertices.size();
		objl::Vertex v;
		const float scaleFactor = 0.5f; // factorul de scalare
...
void renderFox()
{
	...
	if (wolfVAO == 0)
	{
		...
		Loader.LoadFile("..\\Museum\\Animals\\Fox2\\ipa7x275hkdm.obj");
		objl::Mesh curMesh = Loader.LoadedMeshes[0];
		int size = curMesh.Vertices.size();
		objl::Vertex v;
		const float scaleFactor = 0.5f; // factorul de scalare
...
void renderRabbit()
{
	...
	if (rabbitVAO == 0)
	{
		...
		Loader.LoadFile("..\\Museum\\Animals\\Rabbit\\uploads_files_991253_Rabbit.obj");
		objl::Mesh curMesh = Loader.LoadedMeshes[0];
		int size = curMesh.Vertices.size();
		objl::Vertex v;
		const float scaleFactor = 0.5f; // factorul de scalare
...
void renderDinoTrex()
{
	...
	if (dinoTrexVAO == 0)
	{
		...
		Loader.LoadFile("..\\Museum\\Animals\\Dinosaur2\\TrexByJoel3d.obj");
...
void renderDinoSpino()
{
	...
	if (dinoSpinoVAO == 0)
	{
		...
		Loader.LoadFile("..\\Museum\\Animals\\Dinosaur3\\deino-low.obj");
		objl::Mesh curMesh = Loader.LoadedMeshes[0];
		int size = curMesh.Vertices.size();
		objl::Vertex v;
		for (int j = 0; j < curMesh.Vertices.size(); j++)
...
void renderParrot(const Shader& shader)
{
	...
	glm::mat4 model;
	model = glm::mat4();
	model = glm::translate(model, glm::vec3(11.0f, 7.0f, -23.0f));
...
void renderParrot()
{
	...
	if (parrotVAO == 0)
	{
		...
		Loader.LoadFile("..\\Museum\\Animals\\Parrot\\parrot.obj");
		objl::Mesh curMesh = Loader.LoadedMeshes[0];
		int size = curMesh.Vertices.size();
		objl::Vertex v;
		for (int j = 0; j < curMesh.Vertices.size(); j++)
...
void renderHeron()
{
	...
	if (heronVAO == 0)
	{
		...
		Loader.LoadFile("..\\Museum\\Animals\\bird_00\\bird_00.obj");
		objl::Mesh curMesh = Loader.LoadedMeshes[0];
		int size = curMesh.Vertices.size();
		objl::Vertex v;
		for (int j = 0; j < curMesh.Vertices.size(); j++)
...
void renderFirstSnake(const Shader& shader)
{
	...
	glm::mat4 model;
	model = glm::mat4();
	model = glm::translate(model, glm::vec3(7.0f, 5.4f, -45.7f));
...
void renderFirstSnake()
{
	...
	if (firstSnakeVAO == 0)
	{
		...
		Loader.LoadFile("..\\Museum\\Animals\\FirstSnake\\Snake.obj");
...
void renderSecondSnake()
{
	...
	if (secondSnakeVAO == 0)
	{
		...
		Loader.LoadFile("..\\Museum\\Animals\\ThirdSnake\\smiling_cobra.obj");
